    ...
    <ThemedView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ marginHorizontal: 16, borderRadius: 16, overflow: 'hidden' }}>
          <ActionRow
            {...rowProps}
            icon={<Bell size={20} color={COLORS.onSurfaceVariant} strokeWidth={1.75} />}
        ...
        <View style={{ marginHorizontal: 16, borderRadius: 16, overflow: 'hidden' }}>
          <ActionRow
            {...rowProps}
            icon={<Shield size={20} color={COLORS.onSurfaceVariant} strokeWidth={1.75} />}
        ...
        <View style={{ marginHorizontal: 16, borderRadius: 16, overflow: 'hidden' }}>
          <ActionRow
            {...rowProps}
            icon={<Database size={20} color={COLORS.onSurfaceVariant} strokeWidth={1.75} />}
        ...
        <View style={{ marginHorizontal: 16, borderRadius: 16, overflow: 'hidden' }}>
          <ActionRow
            {...rowProps}
            icon={<Info size={20} color={COLORS.onSurfaceVariant} strokeWidth={1.75} />}
